      ...
      <div className='user__content-wrapper'>
        ...
        <div className='user__profile-header__card'>
          <div className='user__profile-header__overview-wrapper'>
            <span className={`user__profile-header__overview__image-wrapper ${loading ? 'skeleton' : ''}`}>
              {
                (loading) ?
                '' :
                (
                  <img src={`${(user?.profile.avatar) ? user?.profile.avatar : process.env.PUBLIC_URL + '/icons/user-icon.svg'}`} alt='icon'  className={`${user ? 'user__profile-header__overview__image ' : 'user__profile-header__overview_placeholder-icon'}`}/>
                )
              }
            </span>
              ...
              <div className='user__profile-header__overview__details__wrappers'>
                {
                  ...
                  (
                    <>
                      <span className='user__profile-header__skeleton-loader skeleton'></span>
                      <span className='user__profile-header__skeleton-loader skeleton'></span>
                    </>
                  ) :
                  (
                    <>
                      <p className={`user__profile-header__overview__details__name ${loading ? 'skeleton' : ''}`}>{user?.profile.firstName} {user?.profile.lastName}</p>
